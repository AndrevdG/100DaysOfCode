...
if os.path.exists('./data/words_to_learn.csv'):
    words = p.read_csv("./data/words_to_learn.csv").to_dict(orient='records')
else:
...
button_right = tk.Button(image=button_right_image, highlightthickness=0, command=word_learned)
